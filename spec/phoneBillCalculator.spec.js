...
describe("phoneBillCalculator", () => {
  ...
  phone number whose valueis the smaller among the given phones`, () => {
...
describe("getBill", () => {
  ...
  it("should verify the bill for every extra secound to min is 150 cent", () => {
